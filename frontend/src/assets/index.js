...
export const Home = ({ color, size }) => {
  return (
    <svg
      ...
      fill={color}
      viewBox="0 0 24 24"
      className="r-xfsgu1 r-4qtqp9 r-yyyyoo r-lwhw9o r-dnmrzs r-bnwqim r-1plcrui r-lrvibr"
    >
      <g>
...
export const Bookmarks = ({ color, size }) => {
  return (
    <svg
      width={size}
      height={size}
...
export const Explore = ({ color, size }) => {
  return (
    <svg
      width={size}
      height={size}
...
export const Notifications = ({ color, size }) => {
  return (
    <svg
      width={size}
      height={size}
...
export const AddImage = ({ color, size }) => {
  return (
    <svg
      width={size}
      height={size}
...
export const AddGif = ({ color, size }) => {
  return (
    <svg
      width={size}
      height={size}
...
export const AddPoll = ({ color, size }) => {
  return (
    <svg
      width={size}
      height={size}
...
export const AddEmoji = ({ color, size }) => {
  return (
    <svg
      width={size}
      height={size}
...
export const AddSchedule = ({ color, size }) => {
  return (
    <svg
      width={size}
      height={size}
...
export const Retweet = ({ color, size }) => {
  return (
    <svg
      width={size}
      height={size}
...
export const Favorite = ({ color, size }) => {
  return (
    <svg
      width={size}
      height={size}
...
export const TweetOptions = ({ color, size }) => {
  return (
    <svg
      width={size}
      height={size}
...
export const ComposeTweet = ({ color, size }) => {
  return (
    <svg
      width={size}
      height={size}
      fill={color}
      viewBox="0 0 24 24"
      className="r-jwli3a r-4qtqp9 r-yyyyoo r-1q142lx r-50lct3 r-dnmrzs r-bnwqim r-1plcrui r-lrvibr"
    >
      <g>
